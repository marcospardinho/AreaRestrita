        ...
        <section class="content-header sessTit">
            <div class="container-fluid">
                <div class="row mb-2">
                    <!-- Título -->
                    <div class="col-sm-6">
                        <h1 style="font-size: 25px;">Editar Assembleia </h1>
                    </div>
                    <!-- Lado Direito -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate id="formAssembleia" name="formAssembleia"
                        action="{{ route('assembly.update', $assembleia->id_assembleia) }}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="nomeassembleia"
                                            name="nomeassembleia" value="{{ $assembleia->titulo }}" maxlength="100"
                                            placeholder="Título da assembleia" />
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Status</label>
                                        <select name="status" class="form-control custom-select" required="true">
                                            <option value="0" @if ($assembleia->status == 0) selected @endif>Desativada</option>
                                            <option value="1" @if ($assembleia->status == 1) selected @endif>Ativada</option>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div>
                                            <input type="checkbox" id="ativos" name="usuarios[]" @if ($assembleia->permissao->contains('id_usuarios_habilitados', 1)) checked @endif value="1">
                                            <label for="ativos"> &nbspAtivos&nbsp </label>
                                            <input type="checkbox" id="aposentados" name="usuarios[]" @if ($assembleia->permissao->contains('id_usuarios_habilitados', 2)) checked @endif value="2">
                                            <label for="aposentados"> &nbspAposentados&nbsp </label>
                                            <input type="checkbox" id="pensionistas" name="usuarios[]" @if ($assembleia->permissao->contains('id_usuarios_habilitados', 3)) checked @endif value="3">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <textarea id="textoassembleia" name="textoassembleia"
                                            placeholder="Digite o texto da assembleia aqui" class="form-control"
                                            rows="4">{{ $assembleia->descricao }}</textarea>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group date" id="reservationdatetime2"
                                            data-target-input="nearest">
                                            <input type="text" id="dttermino" name="dttermino"
                                                value="{{ $assembleia->fim }}" class="form-control datetimepicker-input"
